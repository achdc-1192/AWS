...
for inputtag in formsoup.find_all('input'):
...
sts_response = sts_client.assume_role_with_saml(RoleArn=role_arn, PrincipalArn=principal_arn, SAMLAssertion=assertion)
